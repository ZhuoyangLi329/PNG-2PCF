...
并显式采用“1Gpc/3Gpc 不同的 PK 拟合 kmin”。

输出:
- 图: task5_v10_fnl0_pk2xi_diffkmin_1gpc_3gpc.png
- 文本: task5_v10_fnl0_pk2xi_diffkmin_1gpc_3gpc_summary.txt
"""
...
OUT_PNG = os.path.join(OUT_DIR, "task5_v10_fnl0_pk2xi_diffkmin_1gpc_3gpc.png")
OUT_TXT = os.path.join(OUT_DIR, "task5_v10_fnl0_pk2xi_diffkmin_1gpc_3gpc_summary.txt")
...
def write_summary(result_1gpc: Dict[str, object], result_3gpc: Dict[str, object]) -> None:
    ...
    with open(OUT_TXT, "w", encoding="utf-8") as f:
        f.write("任务5 v10: fnl0 下 1Gpc/3Gpc 的 best-fit PK -> 2PCF 一致性检查（分盒子 kmin）\n")
        f.write("========================================================\n")
