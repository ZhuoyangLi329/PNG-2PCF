...
输出:
- 图: task5_v11_fnl0_pk2xi_diffkmin_1gpc_3gpc_jointpanel.png
- 文本: task5_v11_fnl0_pk2xi_diffkmin_1gpc_3gpc_jointpanel_summary.txt
"""
...
OUT_PNG = os.path.join(OUT_DIR, "task5_v11_fnl0_pk2xi_diffkmin_1gpc_3gpc_jointpanel.png")
OUT_TXT = os.path.join(OUT_DIR, "task5_v11_fnl0_pk2xi_diffkmin_1gpc_3gpc_jointpanel_summary.txt")
...
def write_summary(result_1gpc: Dict[str, object], result_3gpc: Dict[str, object]) -> None:
    ...
    with open(OUT_TXT, "w", encoding="utf-8") as f:
        f.write("任务5 v11: fnl0 下 1Gpc/3Gpc 的 best-fit PK -> 2PCF 一致性检查（分盒子 kmin + 第三子图叠加）\n")
        f.write("========================================================\n")
