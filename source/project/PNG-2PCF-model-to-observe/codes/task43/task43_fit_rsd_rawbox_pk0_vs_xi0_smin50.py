#!/usr/bin/env python3
"""Reproduce the legacy unmasked Task 4.3.2 P0(k)-xi0(s>=50) comparison.
...
New standard rawbox xi0 inference uses
``task43_run_rawbox_baomask_mcmc_v1.py`` and excludes 80 <= s < 120 Mpc/h.
"""
